...
path('object-oriented-design/problem/<int:problem_id>', views.problem, name='object-oriented-design-problem'),
path('recursion-and-dynamic-programming', views.recursion, name='recursion-and-dynamic-programming'),
path('recursion-and-dynamic-programming/problem/<int:problem_id>', views.problem, name='recursion-and-dynamic-programming-problem'),
path('sorting-and-searching', views.sorting, name='sorting-and-searching'),
path('sorting-and-searching/problem/<int:problem_id>', views.problem, name='sorting-and-searching-problem'),
path('stacks-and-queues', views.stacks, name='stacks-and-queues'),
path('stacks-and-queues/problem/<int:problem_id>', views.problem, name='stacks-and-queues-problem'),
path('system-design-and-scalability', views.scaling, name='system-design-and-scalability'),
path('system-design-and-scalability/problem/<int:problem_id>', views.problem, name='system-design-and-scalability/problem'),
path('testing-and-debugging', views.testing, name='testing-and-debugging'),
path('testing-and-debugging/problem/<int:problem_id>', views.problem, name='testing-and-debugging-problem'),
